...
<form action="index.php?action=signupController" enctype="multipart/form-data" method="post">
  ...
  <div class="input-container">
    ...
    <input class="input-field" id="inputFirstName" type="text" placeholder="First Name" name="firstname" id="firstname" minlength="3" maxlength="20" required>
  </div>
  <div class="input-container">
    <i class="fa fa-user icon"></i>
    <input class="input-field" id="inputLastName" type="text" placeholder="Last Name" name="lastname" id="lastname" minlength="3" maxlength="20" required >
  </div>
 
  <div class="input-container">
    <i class="fa fa-envelope icon"></i>
    <input class="input-field" id="inputEmail"  type="email" placeholder="Email" name="email" id="email" required>
  </div>

  <div class="input-container">
    <i class="fa fa-key icon"></i>
    <input class="input-field" id="inputPassword" type="password" placeholder="Password" id="password" name="password" onchange="count();" >
  </div>
<div class="input-container">
    <i class="fa fa-key icon"></i>
  ...
  <div class="input-container">
    ...
    <input class="input-field"  onkeydown="javascript: return event.keyCode === 8 || event.keyCode === 46 ? true : !isNaN(Number(event.key))"id="Phone" type="phone" placeholder="Mobile number" maxlength="11" min="0" max="9">
  </div>
  <div class="input-container">
  ...
  <button type="submit" id="submitSignUp" id="register" name="register" class="btn">Register</button>
</form>
