...
<?php
    ...
    ?>  
<form  method = "post" action="showsections.php?action=DeleteSection">
<div class="container">
  <div class="row">
    <div class="col-xs-12">
    ...
    <td><input type="text"  id="SectionName" placeholder="Enter Section name" name="SectionName" value="<?php echo $Sectionname;?>" disabled></td>
    <td><input type="time"  id="SectionTime" placeholder="Enter Section time" name="SectionTime" value="<?php echo $Sectiontime;?>" disabled></td>
    <td><input type="text"  id="SectionCost" placeholder="Enter Section cost" name="SectionCost" value="<?php echo $Sectioncost;?>" disabled></td>
    <td><input type="text"  id="SectionLink" placeholder="Enter Section link" name="SectionLink" value="<?php echo $Sectionlink;?>" disabled></td>
