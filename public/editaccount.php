<?php
  ...
  require_once(__ROOT__ . "controller/StudentController.php");
  //require_once(__ROOT__ . "view/ViewTables.php");

  $model = new Student();
  $controller = new StudnetController($model);
...
<?php
    ...
    ?>  
<form  method = "post" action="editaccount.php?action=EditStudentAccount">
<div class="container">
  <div class="row">
    <div class="col-xs-12">
