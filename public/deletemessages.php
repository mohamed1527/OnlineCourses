...
<td><input type="text"  id="reciever" placeholder="Recevier Name" name="reciever" value="<?php echo $receiver;?>" disabled></td>
<td><input type="text"  id="message" placeholder="Message" name="message" value="<?php echo $message;?>" disabled></td>  
