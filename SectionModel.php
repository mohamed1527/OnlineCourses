...
static function addsection($sectionname,$sectiontime,$sectioncost,$sectionlink,$cid){
  ...
  $sql = "INSERT into  Section(SectionName,Sectiontime,Sectioncost,Sectionlink,CourseID) Values('$sectionname','$sectiontime','$sectioncost','$sectionlink','$cid');";
